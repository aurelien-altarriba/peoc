...
// Récupération de l'id du centre équestre qui à créé le parcours sélectionné
$rs = pg_query($idc,$sql = "SELECT id_centre_p
                            FROM parcours
                            WHERE id_parcours_p = $id_p");
$id_centre_p_parcours_selection = pg_fetch_result($rs,0,0);

// Si l'utilisateur clique sur modifier et qu'il est propriétaire du parcours, en CE OU CV
