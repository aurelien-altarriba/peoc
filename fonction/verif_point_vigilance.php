...
// Déclaration de l'id et du numéro du point de vigilance
...
$sql = "INSERT INTO point_vigilance(id_parcours_pv, num_point_pv, dt_creation_pv, dt_debut_pv, dt_fin_pv, id_membre_pv, id_categorie_pv, description_pv, geom_pv)
        VALUES($id_parcours_pv, $num_point_pv, $dt_creation_pv, '$dt_debut_pv', '$dt_fin_pv', $id_membre_pv, $id_categorie_pv, E'$description_pv',
          ST_GeomFromText('POINT($lng $lat)', ".$CF['srid']."))";
print($sql);
