<?php
  ...
  // RÉCUPERATION VARIABLE DE SESSION
  ...
  if ($action == 3) {
    ...
    if ($action == 1) {
      ...
      $sql = "INSERT INTO membre (nom_m, prenom_m, dt_naissance_m, adresse_m, cp_m, ville_m, id_pays_m, tel_m, mail_m)
              VALUES('$nom', '$prenom', '$date_naissance', '$adresse', '$CP', '$ville', '$pays', '$tel', '$mail')
    ...
    // ACTION UPDATE
      ...
      $sql = "UPDATE membre
              SET nom_m = '$nom', prenom_m = '$prenom', dt_naissance_m = '$date_naissance',adresse_m = '$adresse', cp_m = '$CP',
                ville_m = '$ville', id_pays_m = '$pays', tel_m = '$tel', mail_m = '$mail'
