<form name="frm"  action="../fonction/verif_centre_equestre.php" method="POST" enctype="multipart/form-data">
  <div id="div_centre">
    <?php
      ...
      print('Nom : <input type="text" name="zs_nom_ce" value="'.$nom_ce.'" disabled="disabled"/>');
      print('Adresse : <input type="text" name="zs_adresse_ce" value="'.$adresse_ce.'" disabled="disabled"/>');
      print('Code postal : <input type="text" name="zs_cp_ce" value="'.$cp_ce.'" disabled="disabled"/>');
      print('Ville : <input type="text" name="zs_ville_ce" value="'.$ville_ce.'" disabled="disabled"/>');
      print('Département : <input type="text" name="zs_id_departement_ce" value="'.$id_departement_ce.'" disabled="disabled"/>');
