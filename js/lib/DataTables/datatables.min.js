...
oPaginate:{sFirst:"Premier",sLast:"Dernier",sNext:"Suivant",sPrevious:"Précédent"},sEmptyTable:"Aucune données dans la table",sInfo:"Affichage de _START_ sur _END_ des _TOTAL_ entrées",sInfoEmpty:"Aucune données à afficher",sInfoFiltered:"(filtré de _MAX_ total entrées)",sInfoPostFix:"",sDecimal:"",sThousands:",",sLengthMenu:"Voir _MENU_ entrées",sLoadingRecords:"Chargement...",sProcessing:"Calcul en cours...",sSearch:"Recherche:",sSearchPlaceholder:"",sUrl:"",sZeroRecords:"Aucun résultat trouvé"},oSearch:h.extend({},
